...
class BowlingTest(unittest.TestCase):
    ...
    def test_all_spare_first_nine(self):
        frames = [[9, 1],[9, 1],[9, 1],[9, 1],[9, 1],[9, 1],[9, 1],[9, 1],[9, 1],[9, 0]]
    ...
    def test_all_strike(self):
        frames = [[10, 0],[10, 0],[10, 0],[10, 0],[10, 0],[10, 0],[10, 0],[10, 0],[10, 0],[9, 0]]
        self.assertEqual(7*30 + 29 + 19 + 9, bowling.BowlingScore(frames))

    def test_alternate_strike_spare(self):
        frames = [[10, 0],[9, 1],[10, 0],[9, 1],[10, 0],[9, 1],[10, 0],[9, 1],[10, 0],[9, 0]]
